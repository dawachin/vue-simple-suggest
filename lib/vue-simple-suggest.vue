<template>
  ...
  >
    <div
      class="input-wrapper ms-TextField ms-TextField--underlined"
      ref="inputSlot"
      role="combobox"
    ...
    >
      <label class="ms-Label">DATA</label>
      <slot>
        <input
          class="default-input"
          v-bind="$attrs"
...
<script>
import { defaultControls, modes, fromPath, hasKeyCode } from "./misc";
  ...
  methods: {
    ...
    prepareEventHandlers(enable) {
      ...
      const keyEventsList = {
        ...
        keydown: $event => (
          this.moveSelection($event), this.onAutocomplete($event)
        ),
