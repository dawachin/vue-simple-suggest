        ...
        <v-container>
          <v-layout>
            <v-flex xs8>
              ...
              >
                <v-text-field v-model="model" :counter="max" :rules="nameRules" label="出発駅"></v-text-field>
  ...
  data() {
    return {
      ...
      nameRules: [
        ...
        v => v.length <= this.max || "Name must be less than 10 characters"
      ],
      email: "",
      emailRules: [
